...
def test(cfg, loadname, net):
    ...
    for idx in range(len(file_list)):
        ...
        HR_left = Image.open(cfg.testset_dir + cfg.dataset + '/hr/' + file_list[idx] + '/lr0.png')
        HR_right = Image.open(cfg.testset_dir + cfg.dataset + '/hr/' + file_list[idx] + '/lr1.png')
...
if __name__ == '__main__':
    ...
    net.eval()
    loadname = './checkpoints/SSRDEF_4xSR.pth.tar'
    print(loadname)
